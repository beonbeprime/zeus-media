...
10. Rodar build.js, gerar edit-project.json
11. Renderizar: `npx remotion render MagnaEdit "draft_vXX.mp4" --video-bitrate="4M" --audio-bitrate="192k"`
12. Apresentar e iterar com FULLSAFE
...
- COMPOSICAO REMOTION: SEMPRE `MagnaEdit` - NUNCA ReelsZoomBRolls, RafaelBRolls ou qualquer outra (ERRO 10)
